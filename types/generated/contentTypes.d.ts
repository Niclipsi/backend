...
export interface ApiPaquetesTurismoPaquetesTurismo
  ...
  attributes: {
    ...
    fechaDeSalida: Schema.Attribute.Date;
    hotel: Schema.Attribute.Text;
    Imagen: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::paquetes-turismo.paquetes-turismo'
    > &
      Schema.Attribute.Private;
    noches: Schema.Attribute.String;
    NombreV: Schema.Attribute.String;
    precio: Schema.Attribute.BigInteger;
    publishedAt: Schema.Attribute.DateTime;
    reserva_paquete_linea: Schema.Attribute.Relation<
      'manyToOne',
      'api::reserva-paquete-linea.reserva-paquete-linea'
    >;
    saliendoDesde: Schema.Attribute.String;
    stockViajes: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vuelo: Schema.Attribute.Text;
  };
}

export interface ApiReservaPaqueteLineaReservaPaqueteLinea
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    paquetes_turismos: Schema.Attribute.Relation<
      'oneToMany',
      'api::paquetes-turismo.paquetes-turismo'
    >;
    precioTdeLinea: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    reserva_paquete: Schema.Attribute.Relation<
      'manyToOne',
      'api::reserva-paquete.reserva-paquete'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiReservaPaqueteReservaPaquete
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    reserva_paquete_lineas: Schema.Attribute.Relation<
      'oneToMany',
      'api::reserva-paquete-linea.reserva-paquete-linea'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    users_Colect: Schema.Attribute.Relation<
      'manyToOne',
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    reserva_paquetes: Schema.Attribute.Relation<
      'oneToMany',
      'api::reserva-paquete.reserva-paquete'
    >;
    resetPasswordToken: Schema.Attribute.String & Schema.Attribute.Private;
